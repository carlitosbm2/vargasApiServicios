...
namespace CibertecAPI.Controllers
{
    ...
    public class ProductoController : Controller
    {
        ...
        [HttpPost]
        [Route("Guardar")]
        //public void InsertarProducto(Producto producto) //reizor
            public void InsertarProducto(Producto producto, ICollection<IFormFile>files)//angular para los archivos uplaud
        {
            if(files.Count > 0)
            {
